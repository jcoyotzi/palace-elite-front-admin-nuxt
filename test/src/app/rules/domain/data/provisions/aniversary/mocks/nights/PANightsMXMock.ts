...
export const PANightsMXHappiPathCMock: ProvisionAniversaryRulePayload = {
  market: 'MX',
  nightsToBook: 7,
  hotelHasGolf: false,
  provisions: [
...
export const PANightsMXHappiPathFMock: ProvisionAniversaryRulePayload = {
  market: 'MX',
  nightsToBook: 1,
  hotelHasGolf: false,
  provisions: [
...
export const PANightsMXBadPathDMock: ProvisionAniversaryRulePayload = {
  market: 'MX',
  nightsToBook: 4,
  hotelHasGolf: false,
  provisions: [
