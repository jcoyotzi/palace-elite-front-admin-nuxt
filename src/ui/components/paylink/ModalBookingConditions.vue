...
@Component({})
export default class ModalBookingConditions extends Vue {
  public closeModal() {
    this.paylinkStore.showModalBookingConditions = false
  }
  ...
  get information() {
    ...
    return this.paylinkStore?.collectionTypeTerms?.find(
      attr => attr.attributes.code === 'paylink-booking-conditions'
    )?.attributes
  }

  get showModal(): boolean {
    return this.paylinkStore.showModalBookingConditions
  }
}
</script>
