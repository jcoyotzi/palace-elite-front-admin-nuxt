...
@Component({})
export default class ModalPrivacyNoticies extends Vue {
  public closeModal() {
    this.paylinkStore.showModalPrivacyNoticies = false
  }
  ...
  get information() {
    ...
    return this.paylinkStore?.collectionTypeTerms?.find(
      attr => attr.attributes.code === 'paylink-privacy-noticies'
    )?.attributes
  }

  get showModal(): boolean {
    return this.paylinkStore.showModalPrivacyNoticies
  }
}
</script>
