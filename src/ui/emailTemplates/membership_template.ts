const membershipTemplate = (content: string): string => {
  return `
    <!DOCTYPE html>
    <html>
    <head>
              ...
              <tr>
                ...
                <td align="center"
                  ...
                  <table class="ms-content" width="600" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                      <td>
                        <img src="https://d2azgexewbdl23.cloudfront.net/content/MEMBRESIA_6026c06035.jpg" style="width: 100%; margin: 0; padding: 0;"/>
                      </td>
                    </tr>
                    <tr>
