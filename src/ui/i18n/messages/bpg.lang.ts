export default {
  messages: {
    es: {
      ...
      diamondPresidential: 'Presidencial Diamante',
    ...
    en: {
      ...
      imperialWeeksOrNights: '(1) Imperial Week o (7) Imperials Nights',
      imperialNights: '(7) Imperials Nights',
      imperialWeeks: '(1) Imperial Week',
      villaOrResidence: 'Villas or Residence',
      villa: 'Villas',
      residence: 'Residence',
      affiliatesVIP: 'VIP',
