...
import PersistentStoreRepository from 'app/common/infrastructure/store/PersistentStoreRepository'

export default class PersistentStoreLocalStorageRepository<T extends Store>
  implements PersistentStoreRepository<T>
{
