...
import {AppReservationMember, Context} from 'app/filldatareservation/legacyBin/fillDataReservations'
import {CreateRmFolio} from 'app/reservation/application/CreateRmFolio'
...
export class CreateReservation {
  public run(
    ...
    try {
      const createRmFolio = new CreateRmFolio(
        context,
        _Combinations, // ✅
