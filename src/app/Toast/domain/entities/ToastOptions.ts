...
export type ToastTheme = 'primary' | 'outline' | 'bubble' | 'pe_toast' 
...
export interface ToastOptions {
  ...
  /**
   * Type of the Toast ['success', 'info', 'error']. (default: 'info')
   */
  type?: ToastType
  /**
   * Theme of the toast you prefer (default: 'pe_toast')
   */
