...
// import GetProductsAndPaymentUseCase from '../bookings/application/getProductsAndPaymentsUseCase'
...
export default new ContainerModule((bind: interfaces.Bind) => {
  ...
  // bind<GetProductsAndPaymentUseCase>(bookingTypes.getProductsAndPaymentUseCase).to(
