...
@injectable()
export default class GetCategorysByPropertyUseCase implements UseCase<any, Response<any>> {
  constructor(
  ...
  async run(application: string): Promise<any> {
    return await this.bpgRepository.getCategorysByProperty(application)
  }
}
