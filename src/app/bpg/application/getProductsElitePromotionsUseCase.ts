...
@injectable()
export default class GetProductsElitePromotionsUseCase implements UseCase<QueryAffiliation, Response<any>> {
  constructor(
  ...
  async run(query: QueryAffiliation): Promise<any> {
    return await this.bpgRepository.getProductsElitePromotions(query)
  }
}
