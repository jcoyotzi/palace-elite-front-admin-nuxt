...
@injectable()
export default class GetProductsElitePromotionsUseCase implements UseCase<any, Response<any>> {
  constructor(
  ...
  async run(application: string): Promise<any> {
    return await this.bpgRepository.getProductsElitePromotions(application)
  }
}
