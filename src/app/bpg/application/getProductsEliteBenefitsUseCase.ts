...
@injectable()
export default class GetProductsEliteBenefitsUseCase implements UseCase<any, Response<any>> {
  constructor(
  ...
  async run(application: string): Promise<any> {
    return await this.bpgRepository.getProductsEliteBenefits(application)
  }
}
