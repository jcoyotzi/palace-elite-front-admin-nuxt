...
@injectable()
export default class GetProductsEliteBenefitsUseCase implements UseCase<QueryAffiliation, Response<any>> {
  constructor(
  ...
  async run(query: QueryAffiliation): Promise<any> {
    return await this.bpgRepository.getProductsEliteBenefits(query)
  }
}
