...
@injectable()
export default class GetTermsAndConditionsUseCase implements UseCase<QueryAffiliation, Response<Response<any>>> {
  constructor(
  ...
  async run(query: QueryAffiliation): Promise<Response<Response<any>>> {
    return await this.bpgRepository.getTermsAndConditions(query)
  }
}
